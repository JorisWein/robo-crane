...
void setup()
{
    ...
    pinMode(button1, INPUT_PULLUP); // define buttons
...
void loop()
{
    ...
    {
        if (pos2 > 70) // Ensure servo2 doesn't move past 70 degrees
        {
            pos2--;
            servo2.write(pos2);
            delay(15);
    ...
    {
        if (pos2 < 160) // Ensure servo2 doesn't move below 160 degrees
        {
            pos2++;
            servo2.write(pos2);
            delay(15);
